...
def p_48():
    ...
    exact_match = pc.ExactStringMatching_Stage(["20"], query_len_thresh=3)
    fuzzy_match = pc.FuzzyStringMatching_Stage(0.1, query_len_thresh=3, index_json="fuzzy_match_string_data_plant.json", index_pickle="fuzzy_match_bk_tree_plant.pickle")
